        ...
        <div class="col-lg-6">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-bar-chart"></i> Ubah Data Kasir</div>
            <div class="card-body">
              <form action="" method="post">
                <?php if ($_POST['email']) {
                  ...
                  $jk = $_POST['jk'];
                  $alamat = $_POST['alamat'];
                  $update = "UPDATE kasir SET nama_kasir='$nama', username_kasir='$username', email_kasir='$email', jk_kasir='$jk', alamat_kasir='$alamat' WHERE id_kasir='$id_kasir'";
                  $submit = $conn->query($update);
                  echo '<script>window.alert("Sukses ubah data diri Kasir");window.location = "kasir.php";</script>';
                }
                ?>
