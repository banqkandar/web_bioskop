...
$id = $_GET['id'];
$qyu = $conn->query("SELECT * FROM studio WHERE id='$id'");
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Ubah Data Studio</li>
      </ol>
      <!-- Icon Cards-->
       <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card mb-3">
            ...
            <i class="fa fa-bar-chart"></i> Ubah Data Studio</div>
            <div class="card-body">
              ...
              <?php if($_POST['nama']){
                  ...
                  $harga     = $_POST['harga'];
                  if($harga>999999){
                    echo "Harga tidak boleh lebih dari 6 digit";
                  }else{
                  $update = "UPDATE studio SET nama='$nama', kapasitas='$kapasitas', harga='$harga' WHERE id='$id'";
                  $submit = $conn->query($update);
                  echo '<script>window.alert("Sukses ubah data Studio");window.location = "studio.php";</script>';
                }
              }
                ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="number" class="form-control" name="kapasitas" value="<?php echo $hasil['kapasitas'];?>" required="">
                </div>
              </div>
              <div class="form-group">
